            ...
            <div class="login-container">
              ...
              <div class="demo-login-section">
                ...
                <div class="demo-buttons">
                  <button class="btn btn-sm btn-outline-secondary demo-login" data-type="nuevo">
                    Cliente Nuevo
                  </button>
                  <button class="btn btn-sm btn-outline-secondary demo-login" data-type="casual">
                    Cliente Casual
                  </button>
                  <button class="btn btn-sm btn-outline-secondary demo-login" data-type="permanente">
                    Cliente Permanente
                  </button>
                  <button class="btn btn-sm btn-outline-secondary demo-login" data-type="credito">
                    Cliente con Crédito
                  </button>
                </div>
              </div>
