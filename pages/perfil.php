...
<div class="info-group">
  <label>Cédula</label>
  <div class="value">${userSession.cedula || "No especificado"}</div>
</div>

<div class="info-group">
  <label>Sexo</label>
  <div class="value">${userSession.sexo === "M" ? "Masculino" : userSession.sexo === "F" ? "Femenino" : "No especificado"}</div>
</div>

<div class="info-group">
  <label>Fecha de Nacimiento</label>
  <div class="value">${userSession.nacimiento ? new Date(userSession.nacimiento).toLocaleDateString("es-ES") : "No especificado"}</div>
</div>

<div class="info-group">
  <label>Dirección</label>
  <div class="value">${userSession.direccion || "No especificado"}</div>
</div>
